...
export default async function DirekteStotte({ params: { lng } }: { params: { lng: string } }) {
  ...
  const direkteStatLink = `/images/direkte-stotte/direkte-statistikk-${(['nn', 'nb'].includes(lng) ? 'no' : lng)}.png`
  return (
    <>
      ...
      <main className="project">
        <Breadcrumbs currentPage={t('title')} lng={lng} path={`projects/direkte-stotte`} />
