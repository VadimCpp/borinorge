...
export async function generateMetadata({params: {lng}}:{params: {lng: string}}) {
  ...
  const title = t('redaksjon.meta-title')
  const description = t('redaksjon.meta-description')
  ...
  const metadata: Metadata = {
    ...
    openGraph: {
      ...
      siteName: title,
      images: [{
        url: "/images/preview/redaksjon_1200_630.jpeg",
      }],
    },
    twitter: {
      ...
      site: "@site",
      creator: "@creator", 
      images: "/images/preview/redaksjon_1200_630.jpeg" 
    },
  }
