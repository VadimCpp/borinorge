...
export async function generateMetadata({params: {lng}}:{params: {lng: string}}) {
  ...
  const title = t('weather.meta_title')
  const description = t('weather.meta_description')
  ...
  const metadata: Metadata = {
    ...
    openGraph: {
      ...
      siteName: title,
      images: [{
        url: "/images/preview/nettverk_1200_630.jpeg",
      }],
    },
    twitter: {
      ...
      site: "@site",
      creator: "@creator", 
      images: "/images/preview/nettverk_1200_630.jpeg" 
    },
  }
